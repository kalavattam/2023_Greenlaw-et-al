...
class Transcript:
    ...
    def __init__(self, transcript_id, transcript_name, gene, start_pos, end_pos):
        ...
        with opener as gtf:
            for row in gtf:
                ...
                if annot_type == 'gene':
                    ...
                    t = Transcript(attributes.pop('transcript_id'), attributes.pop('transcript_name'), g, start_pos, end_pos)
