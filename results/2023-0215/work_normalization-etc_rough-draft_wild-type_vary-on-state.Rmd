...
```{r I. Do rlog normalization, results='hide', message=FALSE}
...
#### Do rlog normalization
```{r II. Do rlog normalization, results='hide', message=FALSE}
...
```{r III. Do rlog normalization, results='hide', message=FALSE}
...
```{r IV. Perform size-factor estimation, results='hide', message=FALSE}
...
```{r IV. Do rlog normalization, results='hide', message=FALSE}
...
```{r IV. Call DESeq2 using default parameters, results='hide', message=FALSE}
...
#### Do rlog normalization
```{r V. Do rlog normalization, results='hide', message=FALSE}
...
### Run `DESeq2`
#### Call `DESeq2` using default parameters
```{r V. Call DESeq2 using default parameters, results='hide', message=FALSE}
