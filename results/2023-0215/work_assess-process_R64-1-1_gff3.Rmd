---
title: "work_assess-process_R64-1-1_gff3.Rmd"
...
### Clean environment, initialize functions
#### Code
<details>
<summary><i>Code: Clean environment, initialize functions</i></summary>

```{r Clean environment initialize functions, results='hide', message=FALSE, warning=FALSE}
#!/usr/bin/env Rscript
...
### Isolate the features that we (may) want to obtain antisense counts for
#### Code
<details>
<summary><i>Code: Isolate the features that we (may) want to obtain antisense counts for</i></summary>

```{r Isolate the features that we (may) want to obtain antisense counts, results='hide', message=FALSE, warning=FALSE}
#!/usr/bin/env Rscript
...
#### Code
<details>
<summary><i>Code: Record scraps</i></summary>

```{r Record scraps, results='hide', message=FALSE, warning=FALSE}
#!/usr/bin/env Rscript
...
## ...
### Code: ...
`#TODO` *Change the below to use Trinity Q and G1 nascent transcriptome files written with bespoke code and not `rtracklayer::export()`*
<details>
