...
6. Use ~~`rtracklayer`~~ *custom code* to write the converted, collapsed, counts-filtered data objects as `gtf` files. *(Some files output by `rtracklayer` seem to have formatting errors that break downstream analyses.)*
