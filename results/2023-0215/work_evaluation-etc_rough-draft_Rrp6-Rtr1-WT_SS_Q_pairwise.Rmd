...
```{r Make counts matrices, results='hide', message=FALSE}
Q_SS_wt_r1_r6 <- c(
    "WT_Q_day8_tcn_SS_aux-F_tc-F_rep1_tech1",
    "WT_Q_day8_tcn_SS_aux-F_tc-F_rep2_tech1",
    "r1-n_Q_day8_tcn_SS_aux-F_tc-F_rep1_tech1",
...
#  For now, focus on Q_SS_wt_r1_r6
datasets <- Q_SS_wt_r1_r6  #IMPORTANT #COMEBACKTOTHIS
...
```{r Make the model matrices, results='hide', message=FALSE}
...
### For `datasets_wt_r1_r6`, continue factor enumeration (rough-draft)
```{r datasets_wt_r1_r6: continue factor enumeration, results='hide', message=FALSE}
...
### For `datasets_wt_r1_r6`, make the `DESeqDataSet`, `dds`
...
```{r datasets_wt_r1_r6: make dds, results='hide', message=FALSE}
...
for (i in 1:length(datasets_grouped)) {
    ...
    cat(paste0(
        "#  --------------------------------------------------------\n",
        "#  Working with '", names(datasets_grouped)[[i]], "'\n",
        "#  --------------------------------------------------------\n\n"
    ))
...
```{r}
#  MA plots ---------------------------
res$G1_SS_wt_r6$n06d_MA_SC
res$Q_SS_wt_r6$n06d_MA_SC
res$Q_SS_r1_r6$n06d_MA_SC
res$Q_SS_wt_r1$n06d_MA_SC

res$G1_SS_wt_r6$n07d_MA_KL
res$Q_SS_wt_r6$n07d_MA_KL
res$Q_SS_r1_r6$n07d_MA_KL
res$Q_SS_wt_r1$n07d_MA_KL

res$G1_SS_wt_r6$n08d_MA_SC.ctrl_KL
res$Q_SS_wt_r6$n08d_MA_SC.ctrl_KL
res$Q_SS_r1_r6$n08d_MA_SC.ctrl_KL
res$Q_SS_wt_r1$n08d_MA_SC.ctrl_KL
...
#  Volcano plots ----------------------
res$G1_SS_wt_r6$n06e_volcano_SC
res$Q_SS_wt_r6$n06e_volcano_SC
res$Q_SS_r1_r6$n06e_volcano_SC
res$Q_SS_wt_r1$n06e_volcano_SC

res$G1_SS_wt_r6$n07e_volcano_KL
res$Q_SS_wt_r6$n07e_volcano_KL
res$Q_SS_r1_r6$n07e_volcano_KL
res$Q_SS_wt_r1$n07e_volcano_KL

res$G1_SS_wt_r6$n08e_volcano_SC.ctrl_KL
res$Q_SS_wt_r6$n08e_volcano_SC.ctrl_KL
res$Q_SS_r1_r6$n08e_volcano_SC.ctrl_KL
res$Q_SS_wt_r1$n08e_volcano_SC.ctrl_KL
