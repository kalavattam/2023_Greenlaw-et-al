...
#  work_PASA_un_trim_trim-rcor_gene-overlap.sh
#  KA
#  2022-1221
...
for h in "${values[@]}"; do
	...
	value="${h}"
	d_exp="files_PASA_un_trim_trim-rcor_gene-overlap-${value}"
	s_name="submit_PASA_un_trim_trim-rcor_gene-overlap-${value}.sh"
