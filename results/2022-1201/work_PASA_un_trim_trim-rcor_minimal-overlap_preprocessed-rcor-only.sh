...
#  work_PASA_un_trim_trim-rcor_minimal-overlap_preprocessed-rcor-only.sh
#  KA
#  2022-1229
...
#  Set up and run precursor commands -----------------------------------------------
#  Define important variables --------------------------------------------------
d_exp="files_PASA_un_trim_trim-rcor_minimal-overlap"
s_name="submit_PASA_un_trim_trim-rcor_minimal-overlap.sh"
...
for i in "${!info_tx_db[@]}"; do
    ...
    echo "sbatch \"sh_err_out/${s_name}\" \"${str_directory}\" \"${str_experiment}\" \"${str_accessions}\""
