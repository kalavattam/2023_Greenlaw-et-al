...
#  work_PASA_preprocessed-rcor-only_stringent-alignment-overlap.sh
#  KA
#  2022-1229
...
for h in "${values[@]}"; do
    ...
    value="${h}"
    d_exp="files_PASA_rcor-only_stringent-alignment-overlap-${value}"
    s_name="submit_PASA_rcor-only_stringent-alignment-overlap-${value}.sh"
