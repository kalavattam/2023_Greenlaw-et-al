...
#  work_PASA_un_trim_trim-rcor_gene-overlap_preprocessed-rcor-only.sh
#  KA
#  2022-1229
...
for h in "${values[@]}"; do
	...
	value="${h}"
	d_exp="files_PASA_rcor-only_gene-overlap-${value}"
	s_name="submit_PASA_rcor-only_gene-overlap-${value}.sh"
